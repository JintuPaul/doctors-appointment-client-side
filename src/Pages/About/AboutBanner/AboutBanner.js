...
const AboutBanner = () => {
  return (
    <section className="Section01 text-center">
      <div className="flex justify-center items-center h-full md:h-[80vh]  md:px-10 mb-40 lg:mb-20">
        <div className=" text-start container items-center grid grid-cols-1 md:grid-cols-2 gap-2 mt-16 ">
          <div className="mr-5 ml-5 lg:ml-0 lg:mr-16 mb-10">
            <h2 className="text-4xl lg:text-5xl font-[emoji] font-semibold text-start">About Keep Smile</h2>
